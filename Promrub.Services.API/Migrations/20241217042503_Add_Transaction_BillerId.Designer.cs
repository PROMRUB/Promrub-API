...
namespace Promrub.Services.API.Migrations
{
    ...
    [Migration("20241217042503_Add_Transaction_BillerId")]
    partial class Add_Transaction_BillerId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Promrub.Services.API.Entities.CouponEntity", b =>
                {
            ...
            modelBuilder.Entity("Promrub.Services.API.Entities.CustomerTaxEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Promrub.Services.API.Entities.FullTaxNumberEntity", b =>
                {
            ...
            modelBuilder.Entity("Promrub.Services.API.Entities.PaymentTransactionEntity", b =>
                {
                    ...
                    b.Property<Guid?>("CustomerTaxId")
                        .HasColumnType("uuid")
                        .HasColumnName("customer_tax_id");

                    b.Property<string>("FullReceiptNo")
                        .HasColumnType("text")
                        .HasColumnName("full_receipt_no");
            ...
            modelBuilder.Entity("Promrub.Services.API.Entities.PaymentTransactionEntity", b =>
                {
                    b.HasOne("Promrub.Services.API.Entities.CustomerTaxEntity", "CustomerTaxEntity")
                        .WithMany("TransactionEntities")
                        .HasForeignKey("CustomerTaxId");

                    b.Navigation("CustomerTaxEntity");
                });
